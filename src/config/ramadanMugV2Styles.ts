...
export const RAMADAN_MUG_V2_STYLES: RamadanMugV2Style[] = [
  {
    id: "crescent-glow",
    name: "",
    src: "/styles/arabic/ramadan-crescent.webp",
    basePrompt:
      "Elegant Arabic calligraphy of 'Text' integrated subtly within a glowing crescent moon, centered night composition, deep navy sky with soft golden light accents, refined Islamic ambiance, high contrast readability, no extra words or symbols, premium Ramadan artwork, no frame, no border, no mat, no mockup, design-only, full-bleed composition.",
  },
  {
    id: "lantern-light",
    name: "",
    ...
    basePrompt:
      "Arabic name 'Text' illuminated by traditional Ramadan lantern-inspired light, centered composition, warm golden glow against dark blue background, soft ambient shadows, luxurious spiritual atmosphere, crisp readable lettering, no extra text, premium festive print-ready finish, flat artwork only, no mug, no product mockup, no physical lantern scene, no photography.",
  },
  {
    id: "sacred-silhouette",
    name: "",
  ...
  },
  {
    ...
    basePrompt:
      "Arabic calligraphy of 'Text' centered within intricate Islamic geometric patterns, gold ornamental linework on a deep matte black flat background, symmetrical balanced composition, sharp crisp details, high readability, no extra text elements, luxury Ramadan print-ready design, flat 2D artwork only, no mug, no cup, no product shot, no 3D object render.",
  },
  {
    id: "noor-glow",
    name: "",
    ...
    basePrompt:
      "Arabic calligraphy of 'Text' radiating soft divine light glow, centered composition, dark gradient background with subtle golden particles, elegant spiritual ambiance, crisp letter definition, no extra words or symbols, premium Ramadan-themed print-ready artwork.",
  },
  {
    id: "moonlight-silver",
    name: "",
  ...
  },
  {
    ...
    basePrompt:
      "Arabic calligraphy of 'Text' in a rich emerald and antique gold illuminated manuscript style, centered composition, elegant ornamental accents, crisp readable lettering, premium Ramadan atmosphere, flat printable artwork only, no extra text, no mug, no cup, no product mockup, no tabletop scene, no photography.",
  },
  {
    id: "diwani-jali",
    name: "",
  ...
  },
  {
    ...
    basePrompt:
      "Arabic calligraphy of 'Text' in rich illustrated gold ornament style, centered composition, premium dark background, crisp readable letterforms, elegant Ramadan luxury mood, flat printable artwork only, not a real object, no mug, no product photography.",
  },
  {
  ...
  },
  {
    ...
    basePrompt:
      "Ancient-inspired Kufic Arabic calligraphy of 'Text', centered composition, sandstone and ink palette, historical Islamic manuscript atmosphere, precise geometry, clear readable structure, premium printable flat artwork, no mug, no product mockup, no photography.",
  },
  {
    id: "neon-blue",
    name: "",
