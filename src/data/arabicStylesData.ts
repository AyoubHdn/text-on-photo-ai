...
export const ARABIC_CATEGORY_LABELS_AR: Record<string, string> = {
  "Seasonal & Islamic Themes": "مناسبات وطابع إسلامي",
  "Traditional Calligraphy": "خطوط تقليدية",
  "Luxury & 3D Materials": "فخامة وخامات ثلاثية الأبعاد",
  "Modern": "عصري",
  "Nature & Elements": "طبيعة وعناصر",
  "Artistic & Abstract": "فني وتجريدي",
};

export const ARABIC_SUBCATEGORY_LABELS_AR: Record<string, string> = {
  "Ramadan Nights": "ليالي رمضان",
  "Thuluth": "خط الثلث",
  "Diwani": "الديواني",
  "Diwani Modern": "ديواني عصري",
  "Ruq'ah Classic": "رقعة كلاسيكي",
  "Ruq'ah Bold": "رقعة عريض",
  "Classic Nastaliq": "نستعليق كلاسيكي",
  "Kufic": "الكوفي",
  "Ornate Kufic": "كوفي مزخرف",
  "Precious Metals": "معادن ثمينة",
  // "Marble Gold" — keep Latin
  // "Black Gold Minimal" — keep Latin
  "Gemstones": "أحجار كريمة",
  "Crystal": "كريستال",
  "Neon Lights": "أضواء نيون",
  "Light Painting": "رسم بالضوء",
  // "Glitch & Tech" — keep Latin
  "Elemental": "عناصر",
  "Botanical": "نباتي",
  "Creative": "إبداعي",
  "Vintage Poster": "ملصق قديم",
  "Embroidery": "تطريز",
  "Henna": "حنّاء",
};
